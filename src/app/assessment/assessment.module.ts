...
// Ng2PaginationModule,
  ...
  declarations: [
    ...
    // AssessmentFillComponent,
    // AssessmentCharacterComponent,
    // AssessmentWrapperComponent,
    // AssessmentFillWrapperComponent,
    // AssessmentCharacterWrapperComponent,
    // AssessmentPlayWrapperComponent,
    // AssessmentPlayComponent
  ],
  providers: [
    AssessmentResolve
  ]
